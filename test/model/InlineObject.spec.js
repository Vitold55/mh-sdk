...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailHubApi.InlineObject();
  });
  ...
  describe('InlineObject', function() {
    it('should create an instance of InlineObject', function() {
      ...
      //var instane = new MailHubApi.InlineObject();
      //expect(instance).to.be.a(MailHubApi.InlineObject);
    });

    it('should have the property destAddress (base name: "dest_address")', function() {
      // uncomment below and update the code to test the property destAddress
      //var instane = new MailHubApi.InlineObject();
