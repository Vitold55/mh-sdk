...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailHubApi.OneAttachment();
  });
  ...
  describe('OneAttachment', function() {
    it('should create an instance of OneAttachment', function() {
      // uncomment below and update the code to test OneAttachment
      //var instane = new MailHubApi.OneAttachment();
      //expect(instance).to.be.a(MailHubApi.OneAttachment);
    });
