...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailHubApi.InlineResponse2003();
  });
  ...
  describe('InlineResponse2003', function() {
    it('should create an instance of InlineResponse2003', function() {
      ...
      //var instane = new MailHubApi.InlineResponse2003();
      //expect(instance).to.be.a(MailHubApi.InlineResponse2003);
    });
    ...
    it('should have the property billUrl (base name: "bill_url")', function() {
      // uncomment below and update the code to test the property billUrl
      //var instane = new MailHubApi.InlineResponse2003();
      //expect(instance).to.be();
    });
