...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailHubApi.DestinationMailbox();
  });
  ...
  describe('DestinationMailbox', function() {
    it('should create an instance of DestinationMailbox', function() {
      // uncomment below and update the code to test DestinationMailbox
      //var instane = new MailHubApi.DestinationMailbox();
      //expect(instance).to.be.a(MailHubApi.DestinationMailbox);
    });
