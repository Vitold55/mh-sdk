...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailHubApi.UsersApi();
  });
  ...
  describe('UsersApi', function() {
    ...
    describe('usersIdPasswordPut', function() {
      it('should call usersIdPasswordPut successfully', function(done) {
        //uncomment below and update the code to test usersIdPasswordPut
        //instance.usersIdPasswordPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('usersOnboardPost', function() {
      it('should call usersOnboardPost successfully', function(done) {
        //uncomment below and update the code to test usersOnboardPost
        //instance.usersOnboardPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
