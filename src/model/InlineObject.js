...
class InlineObject {
    ...
    constructor(destAddress) { 
        ...
        InlineObject.initialize(this, destAddress);
    }
     ...
     */
    static initialize(obj, destAddress) { 
        obj['dest_address'] = destAddress;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('dest_address')) {
                obj['dest_address'] = ApiClient.convertToType(data['dest_address'], 'String');
            }
        }
        return obj;
    }
 ...
 */
InlineObject.prototype['dest_address'] = undefined;
