...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailHubApi.InlineResponse2006();
  });
  ...
  describe('InlineResponse2006', function() {
    it('should create an instance of InlineResponse2006', function() {
      ...
      //var instane = new MailHubApi.InlineResponse2006();
      //expect(instance).to.be.a(MailHubApi.InlineResponse2006);
    });
    ...
    it('should have the property mails (base name: "mails")', function() {
      // uncomment below and update the code to test the property mails
      //var instane = new MailHubApi.InlineResponse2006();
      //expect(instance).to.be();
    });
