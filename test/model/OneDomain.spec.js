...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailHubApi.OneDomain();
  });
  ...
  describe('OneDomain', function() {
    it('should create an instance of OneDomain', function() {
      // uncomment below and update the code to test OneDomain
      //var instane = new MailHubApi.OneDomain();
      //expect(instance).to.be.a(MailHubApi.OneDomain);
    });
