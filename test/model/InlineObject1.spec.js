...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailHubApi.InlineObject1();
  });
  ...
  describe('InlineObject1', function() {
    it('should create an instance of InlineObject1', function() {
      ...
      //var instane = new MailHubApi.InlineObject1();
      //expect(instance).to.be.a(MailHubApi.InlineObject1);
    });
    ...
    it('should have the property fwdAddresses (base name: "fwd_addresses")', function() {
      // uncomment below and update the code to test the property fwdAddresses
      //var instane = new MailHubApi.InlineObject1();
      //expect(instance).to.be();
    });
